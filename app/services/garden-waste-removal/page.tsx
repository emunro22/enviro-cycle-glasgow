...
const WHAT_WE_TAKE = [
  "Branches, twigs, hedge cuttings",
  "Lawn turf and topsoil",
...
const HOW_IT_WORKS = [
  ...
  },
  {
    step: "02",
    title: "Book a slot",
    body: "Same-day usually available March to October. Winter slots within 48 hours typically.",
  },
  {
    step: "03",
    title: "We do the lifting",
    body: "No need to bag it up if you don't want to. We bring our own contractor bags and load straight from the garden.",
  },
  {
    step: "04",
    title: "Properly processed",
    body: "Green waste goes to a licensed composting facility. Mixed loads sorted for recovery. Transfer note on every job.",
  },
];
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Yes. Turf and topsoil are easy. Mixed rubble or hardcore mixed with soil is also fine but priced slightly higher because of the weight.",
  },
  {
