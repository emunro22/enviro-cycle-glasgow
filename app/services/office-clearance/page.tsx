...
const HOW_IT_WORKS = [
  {
    step: "01",
    title: "Site visit",
    body: "Free site visit so we can scope volume, access, lift availability, and timing constraints. Quote provided within 24 hours.",
  },
  {
    step: "02",
    title: "Schedule around your team",
    body: "Most office clearances happen after 6pm or at weekends so trading isn't disrupted. We coordinate with building management for lift and loading bay access.",
  },
  {
    step: "03",
    title: "Strip-out",
    body: "Trained team dismantles desks, takes apart partitions, and removes everything cleanly. IT gear is logged for the audit trail. Confidential documents are bagged and sealed.",
  },
  {
    step: "04",
    title: "Compliance paperwork",
    body: "Waste transfer note, WEEE documentation, and (where applicable) data destruction certificates provided. Critical for landlord handover and ISO audits.",
  },
];
...
const FAQ = [
  ...
  },
  {
    ...
    a: "We can collect and shred under audit, with destruction certificates provided. For higher-security needs we partner with specialist on-site shredding providers.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. We've done multi-floor commercial strip-outs. For larger projects we'll bring in additional teams and a project manager to coordinate access, scheduling, and reporting.",
  },
  {
