  ...
  return (
    <>
      <nav
        ...
        style={{
          height: 80, // Slightly increased height to accommodate bigger logo
      ...
      >
        <div className="h-full max-w-7xl mx-auto px-5 md:px-8 flex items-center justify-between">
          ...
          >
            ...
            />
            <span className="block w-6 h-0.5 bg-[var(--gold)] transition-all duration-300" style={{ opacity: menuOpen ? 0 : 1 }} />
            <span
              className="block w-6 h-0.5 bg-[var(--gold)] transition-all duration-300"
        ...
        <div className="flex flex-col justify-center items-center h-full px-6 text-center">
          <div className="flex items-center gap-3 mb-12">
            <div className="relative w-[80px] h-[80px]">
              <Image src="/images/logo.png" alt="Envirocycle" fill className="object-contain" />
            </div>
            <span style={{ fontFamily: "var(--font-heading)", color: "var(--cream)", letterSpacing: "0.1em", fontSize: "1.3rem" }}>
              ENVIROCYCLE
            </span>
          </div>
          ...
          <div className="mt-12 flex flex-col gap-4 w-full max-w-xs">
            <a href="tel:+447450435241" className="py-3 rounded-full text-center font-semibold" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(245,240,232,0.2)", color: "var(--cream)" }}>
              Call Us
            </a>
            <a href="#contact" onClick={(e) => { e.preventDefault(); handleNavClick("#contact"); }} className="py-3 rounded-full text-center font-semibold" style={{ background: "linear-gradient(135deg, #d4a017, #f0c040)", color: "#0a1f0b" }}>
              Get a Quote
            </a>
          </div>
        </div>
