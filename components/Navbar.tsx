        ...
        <div className="h-full max-w-7xl mx-auto px-4 sm:px-5 md:px-10 flex items-center justify-between gap-3">
          ...
          <div className="hidden lg:flex items-center gap-4 xl:gap-6 text-sm xl:text-[15px]">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <a
                ...
                aria-label="Envirocycle on Instagram"
                className="w-9 h-9 flex items-center justify-center rounded-full border border-[rgba(212,160,23,0.3)] text-[var(--gold-light)] bg-[rgba(212,160,23,0.1)] hover:scale-110 transition-all"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Envirocycle on TikTok"
                className="w-9 h-9 flex items-center justify-center rounded-full border border-[rgba(212,160,23,0.3)] text-[var(--gold-light)] bg-[rgba(212,160,23,0.1)] hover:scale-110 transition-all"
              >
                <TikTokIcon size={16} />
              </a>
          ...
          <div className="flex lg:hidden items-center gap-1.5 shrink-0">
            <a
              ...
              rel="noopener noreferrer"
              aria-label="Envirocycle on Instagram"
              className="w-8 h-8 flex items-center justify-center rounded-full border border-[rgba(212,160,23,0.3)] text-[var(--gold-light)] bg-[rgba(212,160,23,0.1)]"
            >
